...
blogsSliders.forEach((el, index) => {
  const blogSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](el, {
    ...
    on: {
      init: function () {
        if (window.innerWidth > 900) {
          ...
          blogSwiper.slides.forEach((slide, i) => [slide.addEventListener("click", () => {
...
if (certificateSlides.length) {
  ...
  const designBtns = document.querySelectorAll(".certificate-design__btn-select");
...
function setAbonementType(elements, tabs) {
  elements.forEach(typeBtn => {
    typeBtn.addEventListener("click", e => {
      ...
      const type = wrap.querySelector(".abonement-slide__title").innerText.toLowerCase();
      ...
      const price = wrap.querySelector(".abonement-slide__price").innerText.toLowerCase();
      const orderDataNew = {
        type,
        period,
        count,
...
function setCertificateType(elements, tabs) {
  elements.forEach(typeBtn => {
    typeBtn.addEventListener("click", e => {
      ...
      const type = wrap.querySelector(".certeficat-slide__title").innerText.toLowerCase();
      const count = wrap.querySelector(".counter__count").innerText.toLowerCase();
      const price = wrap.querySelector(".certeficat-slide__price").innerText.toLowerCase();
      const orderDataNew = {
        type,
        count,
        price
...
function selectedAbonementType(orderData) {
  if (orderData) {
    ...
    typesWrap.forEach(card => {
      ...
      const title = card.querySelector(".abonement-slide__title").innerHTML.toLowerCase();
...
function selectedCertificateType(orderData) {
  if (orderData) {
    ...
    typesWrap.forEach(card => {
      card.classList.remove("selected");
      const title = card.querySelector(".certeficat-slide__title").innerHTML.toLowerCase();
      if (title === orderData.type) {
        card.classList.add("selected");
        const count = card.querySelector(".counter__count");
        count.innerHTML = orderData.count;
...
/***/ "./src/js/components/utils/counter.js":
/*!********************************************!*\
  !*** ./src/js/components/utils/counter.js ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/components/utils/select.js":
/*!*******************************************!*\
  !*** ./src/js/components/utils/select.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/components/utils/tabs-entry.js":
/*!***********************************************!*\
  !*** ./src/js/components/utils/tabs-entry.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
const tabButtons = document.querySelectorAll(".tabs-entry__pills .btn");
const tabContents = document.querySelectorAll(".tabs-entry__panels > div");
